...
void URKinematicModel::setup(RobotType m){
    cout << "setup(RobotType=" << m << ")" << endl;
    switch(m){
        case UR3:
            setupUR3();
        break;
...
void URKinematicModel::setup(){
    cout << "URKinematicModel::setup() called with no arguments, defaulting to UR5" << endl;
    setupUR5();
}
void URKinematicModel::setupUR3(){
...
void URKinematicModel::setupUR5(){
    cout << "UR5KinematicModel::setup()" << endl;
    type = UR5;
//    world.setup();
//    world.disableGrabbing();
//    world.setGravity( ofVec3f(0, 0, 0) );
...
void URKinematicModel::setupUR10(){
